...
ActiveRecord::Schema[7.2].define(version: 2026_09_03_134903) do
  ...
  create_table "accounts", id: :serial, force: :cascade do |t|
    ...
    t.boolean "agents_can_only_see_assigned_conversations", default: false, null: false
  ...
  create_table "internal_conversation_participants", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["internal_conversation_id", "user_id"], name: "idx_int_conv_participants_unique", unique: true
    t.index ["internal_conversation_id"], name: "idx_int_conv_participants_conversation"
  ...
  create_table "internal_conversations", force: :cascade do |t|
    ...
    t.boolean "self_chat", default: false, null: false
  ...
  create_table "internal_message_attachments", force: :cascade do |t|
    ...
    t.bigint "account_id", null: false
    t.integer "file_type", default: 3, null: false
    t.string "extension"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_internal_message_attachments_on_account_id"
    t.index ["internal_message_id"], name: "index_internal_message_attachments_on_internal_message_id"
  end
  ...
  add_foreign_key "internal_message_attachments", "internal_messages"
